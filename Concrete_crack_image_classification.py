...
# %%
# 6. Convert the train, valdiation and test dataset into prefetch dataset
...
#14. Model training
EPOCHS=10
history=model.fit(pf_train,validation_data=validation_dataset,epochs=EPOCHS,callbacks=[tb])
...
print('Classification Report: ',
    classification_report(y_pred,label_batch)
    )
